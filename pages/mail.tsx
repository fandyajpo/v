...
const Mail = () => {
  return (
    <div className="flex flex-col justify-center py-16 md:py-24 h-full">
      <Screen>
          ...
          <div className="w-full md:w-full lg:w-2/4 flex flex-col md:gap-y-2">
            ...
            {Settings.map((a, i) => {
              return (
                <div
                  key={i}
                  className="w-full border border-gray-300 md:rounded-md flex text-gray-600 items-center px-4 text-base justify-between font-semibold h-16"
                >
                  <p>{a.title}</p>
                  <ArrowStore />
                </div>
            ...
            <div>
              {AccountConnection.map((a, i) => {
                return (
                  <div
                    key={i}
                    className="w-full flex text-gray-600 items-center px-4 text-base justify-between font-semibold h-12"
                  >
                    <p>{a.title}</p>
                    <ArrowStore />
                  </div>
